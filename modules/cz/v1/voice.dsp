...
dcw=hslider("dcw",.55,0,1,.001);
waveMorph=hslider("waveMorph",0,0,1,.001);
attack=hslider("attack[unit:s]",.006,.001,2,.001);
decay=hslider("decay[unit:s]",.35,.005,4,.001);
sustain=hslider("sustain",.72,0,1,.001);
release=hslider("release[unit:s]",.5,.005,6,.001);
level=hslider("level",.3,0,1,.001);
