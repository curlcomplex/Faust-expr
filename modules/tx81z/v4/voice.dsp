...
declare version "0.4.0-runtime-routing";
declare description "Eight runtime OPZ topologies; qualified v2 waves; provisional shared ADSR and continuous phase/level laws";
import("stdfaust.lib");
opz=library("opz_routes.lib");
...
process=opz.voice(a,freq,ratio1,ratio2,ratio3,ratio4,level1,level2,level3,level4,wave1,wave2,wave3,wave4)*env*velocity*level:fi.dcblockerat(15);
