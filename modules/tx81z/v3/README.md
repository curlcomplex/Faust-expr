...
Qualified head `a7499a6e0d402acb3b15039b187acd859d6f6456`, hosted run `35014434206`. Four topology-contract tests passed; Faust 2.88 compiled eight bounded algorithm graphs and produced nine actual renders (algorithms 0–7 plus an exact cold repeat of algorithm 0). All eight primary render hashes are distinct. Fixed-gain listening file: `01-algorithms-0-to-7.wav`.
