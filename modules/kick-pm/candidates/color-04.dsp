// Color study 04: verified gated body plus independently testable PM and drive.
// Research candidate, not a recovered Elektron algorithm or shipping macro map.
import("stdfaust.lib");
declare name "kick-pm color study 04";
declare version "0.0.4-experiment";
...
// Lab ablations, not shipping knobs. 0: before body envelope; 1: after body.
