...
declare description "Single-note DCO-style candidate; shared chorus and polyphony are outside";
import("stdfaust.lib");
...
state(f0,g0,v0)=audio,pitchHz,env,hit with {
 ...
 // Cleaner mixer/VCF gain staging and independent HPF; no chorus per voice.
