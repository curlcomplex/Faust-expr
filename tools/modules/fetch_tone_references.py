"""Fixed licensed SY Tone previews; unknown settings, broad comparators only."""
...
TRAIN=('SYTN-01','SYTN-03','SYTN-05','SYTN-07','SYTN-10','SYTN-13')
TEST=('SYTN-09','SYTN-16')
