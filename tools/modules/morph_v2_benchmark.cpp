...
int main(int argc,char** argv){try{
 ...
 for(int i=0;i<voices;++i){dsps.push_back(std::make_unique<ModuleDSP>());dsps.back()->init(48000);uis.push_back(std::make_unique<UI>());dsps.back()->buildUserInterface(uis.back().get());uis.back()->finishCleanBenchmark();
