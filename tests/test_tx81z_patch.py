...
class TX81ZPatchTests(unittest.TestCase):
    def test_vced_aced_direct_mapping_and_unresolved_policy(self):
        ...
        # Yamaha op1 is VCED block 39 and ACED block 15.
        b=39; v[b:b+13]=bytes([31,22,13,9,7,44,3,5,1,6,88,37,4]); a[15:20]=bytes([1,6,12,7,0])
        # Operator 2 carries a nonzero EG Shift and exercises the second physical block.
        ...
        self.assertEqual(c['op2EGShift'],3)
        self.assertEqual(u['op1']['output_level'],88)
        self.assertEqual(u['op1']['ratio_coarse'],37)
        self.assertEqual(u['op1']['key_velocity_sensitivity'],6)
